...
> 备注：本报告文件名沿用历史编号 `任务3.1.4完成报告.md`，但在 `docs/任务文档.md` 中对应 Windows 任务 **4.1.4 自动更新**（WIN-204）。
...
1) 设置页「关于」配置（写入配置文件 `update.manifestUri`）：
- `update.enabled`: `true`
- `update.manifestUri`: 更新清单 URL 或本地路径（如：`C:\\path\\latest.json`）
